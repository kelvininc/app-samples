...
class Upload(BaseModel):
    ...
    # le=100_000: the drain reads a whole staged batch into RAM before upload, so this caps
    # the per-upload in-memory buffer. A larger value trades memory for fewer round-trips.
