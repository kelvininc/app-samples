...
class SlackIntegration:
    ...
    def __init__(self, config: Slack) -> None:
        ...
        # Alongside the default connection-error retry, honor Slack's 429 Retry-After so a
        # rate-limited send waits and retries instead of surfacing as a generic failure.
        self.client.retry_handlers.append(AsyncRateLimitErrorRetryHandler())
