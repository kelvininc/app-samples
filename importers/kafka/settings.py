...
# The `security` dimension (protocol + sasl + tls) is shared with the Kafka exporter; keep the
...
class KafkaSecurity(BaseModel):
    ...
    def _blocks_match_protocol(self) -> "KafkaSecurity":
        ...
        # ValidationError, not an uncaught aiokafka ValueError that crashes the connector.
...
class Kafka(BaseModel):
    ...
    group_id: str = Field(default="kelvin-kafka-importer", min_length=1)
